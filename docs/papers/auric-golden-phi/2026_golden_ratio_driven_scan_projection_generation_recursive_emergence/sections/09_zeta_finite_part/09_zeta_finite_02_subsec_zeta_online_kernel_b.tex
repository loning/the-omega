...
若希望在“核版 RH/RH-sharp 的临界线模态”框架内把高度 \(T\) 内的临界线零极点密度提升到 \(N(T)\asymp T\log T\) 量级（如经典 Riemann--von Mangoldt 主项），则对任意固定 \(\lambda>1\) 的有限维核，必要地必须引入一族随尺度增长的核 \(M_T\) 使其临界圆模态数 \(B=B(T)\) 满足
\[
