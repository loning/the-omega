...
在命题 \ref{prop:pom-fiber-index-ldp-from-collision-spectrum} 的设定下，进一步假设 \(\Lambda\) 在 \(q=0\) 的邻域二次可微并满足标准的谱隙/解析扰动条件（从而“取极限/求导”可交换；见定理 \ref{thm:pom-fiber-index-clt-thermo}）。
