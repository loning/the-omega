...
Run these commands manually during audit:
  ...
  -- bridge:weight-zero-iff-allFalse → weight w = 0 ↔ w = allFalse (Weight.lean)
  #print axioms Omega.weight_zero_iff_allFalse
  -- bridge:conclusion-window6-standard-collision → S_2(6) = 220 ≠ 212 (Window6.lean)
  #print axioms Omega.conclusion_window6_standard_collision
  ...
  -- prop:pom-moment-congruence-q（推论，一般q）→ S_q(m) > F_{m+2} for q ≥ 1, m ≥ 2 (MomentBounds.lean:487)
  #print axioms Omega.momentSum_gt_fib
  -- bridge:maxFiber-pow-le-momentSum → D(m)^q ≤ S_q(m) (MomentBounds.lean:502)
  #print axioms Omega.maxFiberMultiplicity_pow_le_momentSum
  -- prop:pom-power-sum-hankel-psd（推论，一般q）→ D(m) < S_q(m) for q ≥ 1, m ≥ 2 (MomentBounds.lean:512)
  #print axioms Omega.maxFiberMultiplicity_lt_momentSum
...
def coreAuditTargets : List String :=
  ...
  -- Phase 166 补充: CollisionDecomp.lean 桥接定理 (CollisionDecomp.lean:777)
  , "Omega.exactWeightCollision_recurrence" ]
