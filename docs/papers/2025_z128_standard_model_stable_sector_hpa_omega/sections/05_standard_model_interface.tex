...
\begin{proposition}[Defect mismatch forces compensating connections (interface)]
...
In a continuum modeling dictionary, such compensating fields are represented as gauge connections.
\end{proposition}
...
The content of Proposition~\ref{ax:gauge_compensation} is operational: gauge redundancy arises because compensation is only defined up to local rephasing of the readout basis.
...
\end{proposition}
\begin{proof}
If the three defect channels are independent and commuting, their mismatch certificates can be compared and canceled separately.
Independent local basis changes for each channel imply three independent covariant-transport rules; bundling these rules yields a direct product structure at the level of local redundancy.
\end{proof}
