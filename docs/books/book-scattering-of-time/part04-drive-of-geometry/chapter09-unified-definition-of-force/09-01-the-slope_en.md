...
This means **time density** is higher near the ground. As we saw in Chapter 8 discussing $\kappa(\omega)$, time delay means geometric path winding and accumulation. Earth is like a giant time magnet; Hilbert Space around it is extremely compressed and curled, forming a high-density "time deep well."
...
Objects always tend to slide toward places where their internal evolution ($v_{int}$) can be maximally "accommodated." This is the essence of gravity: **It is not pull; it is slope.**
...
In physics, we habitually say force is the gradient of potential energy ($F = -\nabla V$). But in our geometric universe, energy is just the length of evolution vectors. A more fundamental quantity is **distance**.
