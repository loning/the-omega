...
- [1.1 The War of Two Gods](part01-silent-passage/chapter01-afternoon-in-hilbert-space/01-01-war-of-two-gods_en.md)
- [1.2 The Universe Final Object ($\mathfrak U$) and the Single Axiom](part01-silent-passage/chapter01-afternoon-in-hilbert-space/01-02-universe-final-object-axiom_en.md)

#### Chapter 2: Time Before Time

- [2.1 Pure Becoming](part01-silent-passage/chapter02-time-before-time/02-01-pure-becoming_en.md)
- [2.2 The Art of Projection](part01-silent-passage/chapter02-time-before-time/02-02-art-of-projection_en.md)
- [2.3 The Rosetta Stone](part01-silent-passage/chapter02-time-before-time/02-03-rosetta-stone_en.md)

### Part II: The Great Dispersion

In Part I, we established the universe's ontology: a state vector evolving at constant rate $c$ in Hilbert Space. But this is only the background of the story. In the foreground, in our sensory world, this unified rate is scattered. It splits into what we see as "spatial displacement" and "temporal flow."

This splitting is the origin of all motion and change in physics.

#### Chapter 3: Pythagoras Rules the Universe

- [3.1 The Great Trade-off](part02-great-dispersion/chapter03-pythagoras-rules-universe/03-01-great-trade-off_en.md)
- [3.2 The Bankruptcy of the Photon](part02-great-dispersion/chapter03-pythagoras-rules-universe/03-02-bankruptcy-of-photon_en.md)

#### Chapter 4: The Weight of Time

- [4.1 The Geometric Origin of Mass](part02-great-dispersion/chapter04-weight-of-time/04-01-geometric-origin-of-mass_en.md)
- [4.2 The Nature of Inertia](part02-great-dispersion/chapter04-weight-of-time/04-02-nature-of-inertia_en.md)
- [4.3 The Locking of Energy](part02-great-dispersion/chapter04-weight-of-time/04-03-locking-of-energy_en.md)

#### Chapter 5: The Bankruptcy of the Photon

- [5.1 The Cost of Immortality](part02-great-dispersion/chapter05-bankruptcy-of-photon/05-01-cost-of-immortality_en.md)
- [5.2 The Pauper of Calculation](part02-great-dispersion/chapter05-bankruptcy-of-photon/05-02-pauper-of-calculation_en.md)
...
- [6.1 Quantum Cellular Automaton (QCA)](part03-knots-of-time/chapter06-underlying-pixels/06-01-quantum-cellular-automaton_en.md)
- [6.2 Causality as Connection Speed](part03-knots-of-time/chapter06-underlying-pixels/06-02-causality-as-connection-speed_en.md)
- [6.3 The Vanishing Mosaic](part03-knots-of-time/chapter06-underlying-pixels/06-03-vanishing-mosaic_en.md)

#### Chapter 7: Particles as Defects

- [7.1 Topological Knots](part03-knots-of-time/chapter07-particles-as-defects/07-01-topological-knots_en.md)
- [7.2 Compression Residuals](part03-knots-of-time/chapter07-particles-as-defects/07-02-compression-residuals_en.md)
- [7.3 Symmetry as Backup](part03-knots-of-time/chapter07-particles-as-defects/07-03-symmetry-as-backup_en.md)

#### Chapter 8: Resonance as Residence

- [8.1 The $\kappa(\omega)$ Function: Bridge Between Micro and Macro](part03-knots-of-time/chapter08-resonance-as-residence/08-01-kappa-function_en.md)
