...
\begin{theorem}[容量曲线的 dyadic Mellin 公式：由预言机容量直接恢复全部幂和]\label{thm:xi-dyadic-oracle-capacity-mellin-recovery}
...
\]
因此一旦 dyadic 预算曲线 \(C_m(B)\) 已知，全部正阶幂和 \(\{S_q(m)\}_{q>1}\) 都可由显式 Mellin 积分直接重构。
\end{theorem}
\begin{proof}
