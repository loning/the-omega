...
We propose the following interface hypothesis:
...
In this paper, we formulate this as an implementation budget: compensation has a cost, and the effective dynamics favors minimal discrepancy subject to protocol constraints.
