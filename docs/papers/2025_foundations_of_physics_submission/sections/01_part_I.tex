...
\begin{itemize}
    ...
    \item \textbf{O5 (Scan--projection readout)}: Operational time and outcome statistics are obtained from finite-resolution scan and projection of intrinsic phase data (with standard consequences such as Sturmian readouts and canonical Ostrowski/Zeckendorf tick coordinates recorded as propositions in Part~II and Appendix).
