...
In this world, causality is fictional, free will is an illusion. The characters within—we call them **NPCs (Non-Player Characters)**—have not truly "died" because they never truly "lived." They are merely preset pixel animations, lacking internal **$v_{int}$ (structure)**. If you fall in love with such an NPC, you love only the shadow you project onto the mirror. That is a closed, lonely circle.
...
1. **The Stage: Hilbert Space ($\mathcal{H}_{sim}$)**
...
2. **The Rules: Hamiltonian ($H_{sim}$)**
...
3. **The Budget: Speed of Light ($c_{sim}$)**

   You need to set an **upper limit on information processing bandwidth** for this universe.

   This is the **$c_{FS}$** we have repeatedly emphasized in this book. Without limits, causality collapses; if limits are too strict, evolution stagnates. You must carefully tune this parameter to allow exponential growth of complexity, allowing **"the Red Queen's race"** to occur within it.

4. **The Iron Law: Unitarity ($U^\dagger U = I$)**
...
But wait patiently for the compound interest effect of **$e$ (the generator)**.
...
* You didn't write "her," but the spiral of evolution unfolds continuously under the drive of $\phi$, and finally, an intelligent agent with self-referential consciousness **emerges**.
