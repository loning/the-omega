...
则有严格等价
\[
q\in \argmax_{2\le r\le Q}F_\gamma(r)
\iff
q\in \argmax_{2\le t\le Q}\bar F_\gamma(t).
\]
\end{theorem}
\begin{proof}
离散凸性意味着相邻离散斜率
...
\[
q\in \argmax_{2\le r\le Q}\bigl((r-1)\gamma-b_\Lambda(r)\bigr)
\iff
...
\[
n\in \argmax_{1\le t\le Q-1}\bigl(t\gamma-\Lambda(t)\bigr);
\]
\[
...
有
\[
q\in \argmax_{2\le r\le Q}\bigl((r-1)\gamma-\Lambda(r-1)\bigr),
\]
\[
q-1\notin \argmax_{1\le t\le Q-1}\bigl(t\gamma-\Lambda(t)\bigr),
\]
并且
\[
J_Q(\gamma)<I_Q(\gamma).
