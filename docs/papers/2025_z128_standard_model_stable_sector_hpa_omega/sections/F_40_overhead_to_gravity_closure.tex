...
$\Var(\widehat\gamma)=1/\sum_i (x_i^2/\sigma_{y,i}^2)$ (Proposition~\ref{prop:wls_gamma_variance}), yielding an immediate confidence interval under an approximate normality heuristic.
