...
\begin{remark}[猜想 8.1006 的肯定化]\label{rem:pom-diagonal-rate-schur-concavity-conjecture-81006}
...
因此文内所述 Schur--凹性猜想（猜想 8.1006）得到严格证明。
\end{remark}
...
\begin{proposition}[最优对偶势的反序比较律]\label{prop:pom-diagonal-rate-dual-potential-reverse-order}
