...
Then in the continuum limit $\varepsilon \to 0$, the probability amplitude distribution $\Psi(x,t)$ generated by the system evolution operator $\hat{U}^N$ (where $N = t/\varepsilon$) **uniformly converges** to the solution of the massive Dirac equation $(i \slashed{\partial} - m)\Psi = 0$.
