...
**论文实际规模**：10,588 个定理级陈述（5,347 theorem + 2,356 proposition + 2,821 corollary + 64 lemma），544 个定义，450 个猜想，2,637 个 .tex 文件（body 1,905 + appendix 266 + generated 464），21 个 body 章节 + 13 个附录章节。

**Lean4 状态**：922 个论文标签已注册到 SourceMap，0 公理，0 sorry，lake build 通过。

| 度量 | 数值 |
|---|---|
| 全局覆盖率 | 922/10,588 = **8.7%** |
| 强覆盖（一般性证明） | ~50 (0.5%) |
| 中覆盖（有界+条件） | ~150 (1.4%) |
| 弱覆盖（数值/代理） | ~720 (6.8%) |
