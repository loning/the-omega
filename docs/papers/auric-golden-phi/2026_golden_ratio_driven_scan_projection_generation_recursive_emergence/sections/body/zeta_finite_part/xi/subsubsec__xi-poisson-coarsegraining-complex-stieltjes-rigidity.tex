...
\begin{remark}[同形检索与系数指纹]\label{rem:xi-poisson-cauchy-complex-stieltjes-rigidity-search-note}
本节主链的可检索指纹包括：
\[
\frac{3}{32},\quad
\frac{\binom{2m-2}{m-1}}{2^{2m}},\quad
\frac{(t+\bar a)I_1}{D_{\mathrm{KL}}}\to 2m,
\]
以及六次项组合
\[
\frac{\sigma^6}{64}-\frac{\sigma^2m_4}{8}+\frac{3m_3^2}{32}.
\]
对应审计脚本：
\texttt{scripts/exp\_xi\_poisson\_cauchy\_complex\_stieltjes\_rigidity\_audit.py}。
\end{remark}
