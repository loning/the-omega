...
\end{proposition}
\begin{proof}
Standard; see, e.g., \cite{PeskinSchroeder1995,WeinbergQFT1995}.
\end{proof}
...
In \cite{Ma2025PCG}, the same integers are fixed by bounded-complexity rigidity in electroweak matching ($13=10+3$) and in CP-odd multiplicity ($d_{\mathrm{CP}}=8+3$), making the identity $21=(8+3)+10$ a concrete numerical target that is enforced simultaneously by representation content and by the three-channel rigidity doctrine.
...
The Standard Model labeling of the $21$ stable types at the minimal balanced coupling $(m,n)=(6,3)$ is closed and unique:
...
In this paper, the protocol flow law is fixed explicitly as a discrete uplift--coarse-graining flow together with a standard RG dictionary in the resolution coordinate $r$ \cite{Ma2025PCG,Wilson1974,Rothe2012}.
