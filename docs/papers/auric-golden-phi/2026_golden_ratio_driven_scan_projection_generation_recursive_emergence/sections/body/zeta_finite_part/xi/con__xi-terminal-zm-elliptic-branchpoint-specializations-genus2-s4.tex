...
% According to a document from 2026-02-16.
% 当前时间（Asia/Singapore）：2026-02-17 13:05
...
\begin{conclusion}[判别式二次脊上的循环三次无分歧覆盖的显式模型：三次分解式与规范化纤维积]\label{con:xi-terminal-zm-discriminant-ridge-etale-c3-explicit-model}
