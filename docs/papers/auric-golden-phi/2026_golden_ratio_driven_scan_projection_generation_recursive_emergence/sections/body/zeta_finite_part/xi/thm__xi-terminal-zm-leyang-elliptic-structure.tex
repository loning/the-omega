...
\]
从而 \((\lambda,y)\mapsto(x,w)\) 给出 \(\mathcal C\) 在短 Weierstrass 形式 \(w^{2}=4x^{3}-4x+1\) 下的显式代数表示，其逆映射为 \(y=x^{2}-\tfrac12+\tfrac{w}{2}\)。
...
\begin{itemize}
  ...
  从而临界值满足显式表达式
  \[
  y=x^2+u=\frac{4x^3-3x^2-2x+1}{4x}=x^{2}-\frac34x-\frac12+\frac{1}{4x}.
  \]
\end{itemize}
