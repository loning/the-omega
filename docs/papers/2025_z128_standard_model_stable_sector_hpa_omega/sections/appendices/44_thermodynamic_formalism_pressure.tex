...
\begin{remark}[Unified bridge statement]\label{rem:full_shift_entropy_gap_bridge}
\AuditTag The same constant $\log(2/\varphi)$ also appears as a conditional-entropy rate for finite observability and as a degeneracy growth rate for folding fibers.
For a single reusable statement that unifies these readings, see Proposition~\ref{prop:rigidity_log2phi_triple_reading}.
\end{remark}
...
\midrule
\input{sections/generated/weighted_pressure_sweep_rows.tex}%
\end{tabular}
...
\midrule
\input{sections/generated/pole_barrier_mode_toy_rows.tex}%
\end{tabular}
