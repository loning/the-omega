...
\[
\tau_m(r)\equiv (F_{m+1}-1)-r\pmod{F_{m+2}}.
\]
...
\begin{proof}
记 \(S_m:=\sum_{k=1}^m F_{k+1}=F_{m+3}-1\)。
则
\[
...
\(
S_m=F_{m+3}-1\equiv F_{m+1}-1\pmod{F_{m+2}}
\)，
从而
\[
r(C(\omega))\equiv (F_{m+1}-1)-r(\omega)=\tau_m(r(\omega))\pmod{F_{m+2}}.
\]
