% (User input window)
% 日期与时间：2026-02-17 01:52:00（Asia/Singapore）
% 日期与时间：2026-02-17 02:46:37（Asia/Singapore）
% 日期与时间：2026-02-17 12:40:09（Asia/Singapore）
...
\begin{conclusion}[重量四覆叠的 Hurwitz 护照与分歧除子：\texorpdfstring{$(2,2,2,2,2,4)$}{(2,2,2,2,2,4)} 的完全显式化]\label{con:xi-terminal-zm-elliptic-y-hurwitz-passport}
