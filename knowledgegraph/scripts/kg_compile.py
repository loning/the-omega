...
def build_main_tex(inputs: Sequence[Path], *, fragment_ref_mode: bool = False) -> str:
    ...
    if fragment_ref_mode:
        ...
        lines.append("\\hfuzz=100pt")
        lines.append("\\renewcommand{\\ref}[1]{\\kgrawref{#1}}")
        lines.append("\\renewcommand{\\eqref}[1]{(\\kgrawref{#1})}")
        lines.append("\\renewcommand{\\cite}[1]{\\kgrawref{#1}}")
        lines.append("\\@ifundefined{autoref}{\\providecommand{\\autoref}[1]{\\kgrawref{#1}}}{\\renewcommand{\\autoref}[1]{\\kgrawref{#1}}}")
        lines.append("\\@ifundefined{cref}{\\providecommand{\\cref}[1]{\\kgrawref{#1}}}{\\renewcommand{\\cref}[1]{\\kgrawref{#1}}}")
        lines.append("\\@ifundefined{Cref}{\\providecommand{\\Cref}[1]{\\kgrawref{#1}}}{\\renewcommand{\\Cref}[1]{\\kgrawref{#1}}}")
        lines.append("\\@ifundefined{pageref}{\\providecommand{\\pageref}[1]{\\kgrawref{#1}}}{\\renewcommand{\\pageref}[1]{\\kgrawref{#1}}}")
        lines.append("\\@ifundefined{nameref}{\\providecommand{\\nameref}[1]{\\kgrawref{#1}}}{\\renewcommand{\\nameref}[1]{\\kgrawref{#1}}}")
        lines.append("\\@ifundefined{vref}{\\providecommand{\\vref}[1]{\\kgrawref{#1}}}{\\renewcommand{\\vref}[1]{\\kgrawref{#1}}}")
