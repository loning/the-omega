...
| `Problem4.lean`  | Q4: boxplus-Phi inequality (n=2, n=3 + n=4 quartic-δ algebra + denominator-clearing bridge) | Partial |
...
- **Q4 partial**: n=2 exact identity, n=3 strict inequality bridge, n=4 quartic `δ` closed-form algebra identity, and the denominator-clearing reduction `G₄ = Ξ₄ / (D₁D₂D₁₂)` formalized.
