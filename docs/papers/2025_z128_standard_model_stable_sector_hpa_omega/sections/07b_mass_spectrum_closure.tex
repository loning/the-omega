...
A stronger time/mass matching dictionary based on scattering delay (Wigner--Smith) and relativistic lapse/redshift templates is recorded in Appendix~\ref{app:time_mass_delay}; further dynamical derivations are deferred to the interface road map (Appendix~\ref{app:next_steps}).
\end{remark}
