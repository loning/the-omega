...
围绕 ``Cauchy 位置混合 \(\to\) KL 四阶主项'' 与 ``Poisson 核卷积相对熵渐近'' 的公开检索语料，现有条目主要聚焦两条 Cauchy 分布之间的相对熵闭式及一般 \(f\)-散度性质；未见与本节同型的“位置混合对单峰 Cauchy 参考核”的四阶首项系数 \(1/8\) 的公共表述。
该说明仅反映检索范围内的可见文献状态，不构成排他性证明。
\end{remark}
