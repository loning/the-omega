...
| Q4 | Q4-R13 | PARTIAL PASS (special cases + monotone-sum all-n theorem + heat intertwining + derivative recursion + transform-factor decomposition + edge-score first-moment identity + single-bottleneck sufficient reduction closed; general boxplus n>=4 open) |
| Q5 | Q5-R5 | PASS |
