...
\[
|m_2|^2=
\bigl(\Var(\gamma)-\Var(\delta)\bigr)^2+4\,\Cov(\gamma,\delta)^2.
\]
\end{corollary}
\begin{proof}
...
\begin{remark}[公开索引同形性检索说明]\label{rem:xi-poisson-defect-measure-complex-multipole-public-index-check}
围绕“Poisson/Cauchy 混合相对熵高阶主项”“复中心矩主导”“
\(\binom{2k-2}{k-1}/2^{2k}\) 常数链”等关键词进行公开索引检索，
未见与本节结论同形的现成命题条目。
该检索结论仅构成可检索范围内的同形性排查，不替代严格的新颖性证明。
\end{remark}
