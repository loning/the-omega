...
前述 Dirichlet 扭曲谱、审计偶数窗上的 dyadic 容量、有限分辨率可见算术以及输出位势的零温极限，还可继续压缩为下列四条直接后果。周期层的同余类平方根障碍已由定理 \ref{thm:xi-dirichlet-mode-forces-congruence-residual} 给出；下条表明，经 Witt/M\"obius 投影之后，这一障碍在 primitive 层并不会消失。
