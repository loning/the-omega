...
在 \(u_m=\pi_{m,0}\) 与 \(\mu_m=\pi_{m,1}\) 的末位充分化、两点似然比展开以及幂散度极限闭式都已建立之后，还可把原始切片与稳定层均匀基线之间的统计几何进一步压缩为一个固定二点实验。其后果是：Le Cam 等价、最优判别、\(\chi^2\) 常数反演以及全部 \(f\)-散度极限，都可由同一末位二相结构统一闭合。
...
\begin{corollary}[全部 \texorpdfstring{$f$}{f}-散度极限的二点评价闭包]\label{cor:xi-time-part9sa-fdiv-two-point-evaluation-closure}
设
\[
