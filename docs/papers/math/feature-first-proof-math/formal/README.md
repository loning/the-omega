...
| `Problem4.lean`  | Q4: boxplus-Phi inequality (n=2, n=3 + n=4 quartic-delta algebra + denominator-clearing bridge + factorized-chamber equivalence + B=0 closure + c=0 closure) | Partial |
