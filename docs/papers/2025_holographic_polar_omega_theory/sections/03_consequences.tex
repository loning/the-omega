...
Axiom~O7 makes probability a derived object of finite-resolution readout. In regulated finite-dimensional settings, standard structural results (instrument/POVM calculus and Gleason--Busch characterization) then constrain consistent probability assignments to take the familiar trace form.

\subsection{Orbit traces and Abel finite parts}
Axiom~O8 fixes a canonical normalization for regulated-to-continuum passages: orbit averages become Haar/orbit traces, and constant terms in divergent orbit sums are fixed by Abel finite parts.
