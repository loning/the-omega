...
于是得到第 (2) 条。
第 (3) 条为强正则图的一般谱结论，与本节中 Klingen 邻接算子谱的同一数值一致（参见定理 \ref{thm:xi-klingen-hecke-charpoly-projectors}）。证毕。
\end{proof}
...
\begin{proof}
极大各向同性二维子空间与 \((3,3)\)-同源核的标准对应见命题 \ref{prop:xi-orthogonal-adjacency-33-isogeny}。
