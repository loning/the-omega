...
\input{thm__conclusion_leyang_quartic_essential_prime_spectrum_37_coupling}

\input{thm__conclusion-leyang-loop-certificate-rank-lower-bound}
...
\input{thm__conclusion-prime-register-worst-modulus-mixing-lower-bound}
