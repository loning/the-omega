...
\sum_{n\ge 2}
\#\left\{
k\in\ZZ:\ \left|k+\tfrac12\right|\le R\varphi^{-n}
\right\}
=
\sum_{n\ge 2}2\left\lfloor R\varphi^{-n}+\frac12\right\rfloor.
\]
将 \(R\) 替换为 \(\varphi R\)，得到
\[
N_\varphi(\varphi R)
=
\sum_{n\ge 2}2\left\lfloor R\varphi^{-(n-1)}+\frac12\right\rfloor
=
2\left\lfloor \frac{R}{\varphi}+\frac12\right\rfloor
+
\sum_{m\ge 2}2\left\lfloor R\varphi^{-m}+\frac12\right\rfloor,
\]
其中令 \(m=n-1\)。最后一项正是 \(N_\varphi(R)\)，于是得到所示恒等式。证毕。
\end{proof}
