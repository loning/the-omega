...
\begin{lemma}[Gram 分解与行列式归一化]\label{lem:pom-Kk-gram-det}
...
\begin{proposition}[高阶矩的 Bernoulli--多项式律：奇角 \texorpdfstring{\(\csc^{2r}\)}{csc^{2r}} 幂和]\label{prop:pom-csc-moments-bernoulli}
对整数 \(r\ge 1\) 定义
\[
...
\begin{remark}[可审计实例：前三阶幂和闭式]\label{rem:pom-csc-moments-examples}
写 \(n:=2k+1\)。
则
\[
