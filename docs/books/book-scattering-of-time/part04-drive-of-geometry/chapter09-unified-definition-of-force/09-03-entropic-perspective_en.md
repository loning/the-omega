...
1.  **Slope (9.1):** Force is natural sliding on geometric structure.

2.  **Longing (9.2):** In living beings, this sliding manifests as pursuit of "true self."

3.  **Entropy (9.3):** At the bottom, all this is statistical necessity because the universe tends to maximize its possibilities.
...
No. Because as we saw in section 9.2, life has the ability to **set targets ($\psi_{target}$)**. Although we cannot change sliding rules, we can choose sliding directions.
