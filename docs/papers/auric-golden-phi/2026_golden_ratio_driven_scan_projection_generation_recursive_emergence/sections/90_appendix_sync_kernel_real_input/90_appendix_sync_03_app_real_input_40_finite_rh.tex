...
\begin{enumerate}
  ...
  primitive 主项 \(p_n\sim \lambda^n/n\) 在末项主导下等价转写为 \(\pi(x)\sim \frac{\lambda\log\lambda}{\lambda-1}\frac{x}{\log x}\)（见本附录第 \ref{par:finite-rh-angle-entropy} 段前的“primitive 轨道计数曲线与 \(x/\log x\)”段落）。
