...
, { label := "bridge:lucas-num-pos"
    sourcePath := "sections/body/folding/subsec__folding-fibonacci-stable-syntax.tex"
    moduleName := "Omega.Folding.ShiftDynamics"
    leanName := "Omega.lucasNum_pos"
    phase := 118
    status := .formalized }
, { label := "bridge:lucas-fibonacci-product"
    sourcePath := "sections/body/folding/subsec__folding-fibonacci-stable-syntax.tex"
    moduleName := "Omega.Folding.ShiftDynamics"
...
-- Folding: thm:folding-stable-syntax-fib-fusion-ring, prop:fold-inverse-limit-xm-xinfty
, { label := "def:pom-fiber-spectrum"
    sourcePath := "sections/body/pom/parts/subsec__pom-moment-visibility.tex"
    moduleName := "Omega.Folding.FiberSpectrum"
    leanName := "Omega.cFiberSpectrum"
    phase := 138
    status := .formalized }
, { label := "cor:pom-fiber-modq-pisano-invariant"
    sourcePath := "sections/body/pom/parts/cor__pom-fiber-modq-pisano-invariant.tex"
    moduleName := "Omega.Core.Fib"
    leanName := "Omega.fib_even_iff_three_dvd"
    phase := 138
    status := .formalized }
, { label := "thm:pom-moment-hankel"
    sourcePath := "sections/body/pom/parts/subsec__pom-moment-visibility.tex"
    moduleName := "Omega.Folding.HankelSpectrum"
    leanName := "Omega.hankelS2_3x3_det_ne_zero"
    phase := 138
...
, { label := "def:pom-s5"
    sourcePath := "sections/body/pom/parts/subsec__pom-s5.tex"
    moduleName := "Omega.Folding.MomentSum"
    leanName := "Omega.cached_cMomentSum_5_0"
    phase := 138
    status := .formalized }
, { label := "def:fib-moves"
    sourcePath := "sections/body/emergent_arithmetic/subsec__emergent-arithmetic-zeckendorf-value-address.tex"
    moduleName := "Omega.Folding.Rewrite"
    leanName := "Omega.DigitCfg"
    phase := 138
    status := .formalized }
, { label := "lem:fib-divisibility-chain"
    sourcePath := "sections/body/emergent_arithmetic/subsec__emergent-arithmetic-zeckendorf-value-address.tex"
    moduleName := "Omega.Core.Fib"
    leanName := "Omega.fib_dvd_mul"
    phase := 138
    status := .formalized }
, { label := "lem:fib-divisibility-iff"
    sourcePath := "sections/body/emergent_arithmetic/subsec__emergent-arithmetic-zeckendorf-value-address.tex"
    moduleName := "Omega.Core.Fib"
    leanName := "Omega.fib_gcd"
    phase := 138
    status := .formalized }
, { label := "thm:folding-stable-syntax-fib-fusion-ring"
    sourcePath := "sections/body/folding/subsec__folding-fibonacci-stable-syntax.tex"
    moduleName := "Omega.Folding.FiberRing"
    leanName := "Omega.X.instCommRing"
    phase := 138
    status := .formalized }
, { label := "prop:fold-inverse-limit-xm-xinfty"
    sourcePath := "sections/body/folding/subsec__folding-map.tex"
    moduleName := "Omega.Folding.InverseLimit"
...
, { label := "prop:pom-s3-recurrence"
    ...
    phase := 153
    status := .formalized }
-- Phase 154: S3Recurrence.lean 新定理 4 条 (S3Recurrence.lean:86,103,112,138)
-- prop:pom-s3-recurrence → recurrence_unique_three (S3Recurrence.lean:86)
-- prop:pom-s3-recurrence → momentSum_three_recurrence_sub_of (S3Recurrence.lean:103)
-- prop:pom-s3-recurrence → momentSum_three_strict_mono_of (S3Recurrence.lean:112)
-- prop:pom-s3-recurrence → momentSum_three_double_of (S3Recurrence.lean:138)
, { label := "prop:pom-s3-recurrence"
    sourcePath := "sections/body/pom/parts/subsec__pom-s5.tex"
    moduleName := "Omega.Folding.S3Recurrence"
    leanName := "Omega.recurrence_unique_three"
    phase := 154
    status := .formalized }
, { label := "prop:pom-s3-recurrence"
    sourcePath := "sections/body/pom/parts/subsec__pom-s5.tex"
    moduleName := "Omega.Folding.S3Recurrence"
    leanName := "Omega.momentSum_three_recurrence_sub_of"
    phase := 154
    status := .formalized }
, { label := "prop:pom-s3-recurrence"
    sourcePath := "sections/body/pom/parts/subsec__pom-s5.tex"
    moduleName := "Omega.Folding.S3Recurrence"
    leanName := "Omega.momentSum_three_strict_mono_of"
    phase := 154
    status := .formalized }
, { label := "prop:pom-s3-recurrence"
    sourcePath := "sections/body/pom/parts/subsec__pom-s5.tex"
...
, { label := "bridge:fft-eq-sum"
    ...
    phase := 155
    status := .formalized }
-- Phase 156: S3Recurrence.lean 新定理 4 条 (S3Recurrence.lean:262,272,282,292)
-- prop:pom-s3-recurrence → momentSum_three_eight_of (S3Recurrence.lean:262)
-- prop:pom-s3-recurrence → momentSum_three_nine_of (S3Recurrence.lean:272)
-- prop:pom-s3-recurrence → momentSum_three_ten_of (S3Recurrence.lean:282)
-- prop:pom-s3-recurrence → momentSum_three_even_of (S3Recurrence.lean:292)
, { label := "prop:pom-s3-recurrence"
    sourcePath := "sections/body/pom/parts/subsec__pom-s5.tex"
    moduleName := "Omega.Folding.S3Recurrence"
    leanName := "Omega.momentSum_three_eight_of"
    phase := 156
    status := .formalized }
, { label := "prop:pom-s3-recurrence"
    sourcePath := "sections/body/pom/parts/subsec__pom-s5.tex"
    moduleName := "Omega.Folding.S3Recurrence"
    leanName := "Omega.momentSum_three_nine_of"
    phase := 156
    status := .formalized }
, { label := "prop:pom-s3-recurrence"
    sourcePath := "sections/body/pom/parts/subsec__pom-s5.tex"
    moduleName := "Omega.Folding.S3Recurrence"
    leanName := "Omega.momentSum_three_ten_of"
    phase := 156
    status := .formalized }
, { label := "prop:pom-s3-recurrence"
    sourcePath := "sections/body/pom/parts/subsec__pom-s5.tex"
...
, { label := "prop:pom-s3-recurrence"
    ...
    phase := 163
    status := .formalized }
-- Phase 164: CCSPrime8Split.lean 新定理（3 条）(CCSPrime8Split.lean:591,598,606)
-- prop:pom-moment-congruence-q → momentSum_three_ge_sq_div (CCSPrime8Split.lean:591)
-- prop:pom-s3-recurrence → momentSum_three_eleven (CCSPrime8Split.lean:598) S_3(11)=227888
-- prop:pom-s3-recurrence → momentSum_three_twelve (CCSPrime8Split.lean:606) S_3(12)=703504
, { label := "prop:pom-moment-congruence-q"
    sourcePath := "sections/body/pom/parts/subsec__pom-s5.tex"
    moduleName := "Omega.Folding.CCSPrime8Split"
    leanName := "Omega.momentSum_three_ge_sq_div"
    phase := 164
    status := .formalized }
, { label := "prop:pom-s3-recurrence"
    sourcePath := "sections/body/pom/parts/subsec__pom-s5.tex"
    moduleName := "Omega.Folding.CCSPrime8Split"
    leanName := "Omega.momentSum_three_eleven"
    phase := 164
    status := .formalized }
, { label := "prop:pom-s3-recurrence"
    sourcePath := "sections/body/pom/parts/subsec__pom-s5.tex"
...
, { label := "bridge:ccs-f-recurrence"
    ...
    phase := 165
    status := .formalized }
-- Phase 166: CCSPrime8Split.lean 桥接定理（1 条）(CCSPrime8Split.lean:653)
-- bridge:ccs-prime-recurrence → ccs_prime_recurrence (CCSPrime8Split.lean:653)
, { label := "bridge:ccs-prime-recurrence"
    sourcePath := "sections/body/pom/parts/subsec__pom-s5.tex"
    moduleName := "Omega.Folding.CCSPrime8Split"
...
, { label := "bridge:e00-recurrence"
    ...
    phase := 166
    status := .formalized }
-- Phase 167: MomentBounds.lean（3 条）(MomentBounds.lean:108,115,133)
-- cor:pom-hidden-bit-entropy → hiddenBitCount_eq_div (MomentBounds.lean:108)
-- thm:pom-right-resolving → Fold_snoc_false_ne_true (MomentBounds.lean:115)
-- prop:pom-s3-recurrence → momentSum_three_div_four (MomentBounds.lean:133)
-- 状态: 已形式化, 审核通过 2026-03-26
, { label := "cor:pom-hidden-bit-entropy"
    sourcePath := "sections/body/pom/parts/subsec__pom-entropy.tex"
    moduleName := "Omega.Folding.MomentBounds"
    leanName := "Omega.hiddenBitCount_eq_div"
    phase := 167
    status := .formalized }
, { label := "thm:pom-right-resolving"
    sourcePath := "sections/body/pom/parts/subsec__pom-entropy.tex"
    moduleName := "Omega.Folding.MomentBounds"
    leanName := "Omega.Fold_snoc_false_ne_true"
    phase := 167
    status := .formalized }
, { label := "prop:pom-s3-recurrence"
    sourcePath := "sections/body/pom/parts/subsec__pom-s3.tex"
...
-- thm:conclusion-foldbin-stable-collapse-ordered-k0-memory（edge separation）→ conclusion_window6_binfold_proper_coloring (Window6.lean)
-- 状态: 已形式化, 审核通过 2026-03-26
, { label := "cor:pom-Lk-surface-free-energy"
    sourcePath := "sections/body/pom/parts/subsec__pom-fence-det.tex"
    moduleName := "Omega.Core.Fib"
    leanName := "Omega.fenceDet_le_pow_three"
    phase := 195
    status := .formalized }
, { label := "prop:crt-235-min-depth"
    sourcePath := "sections/body/pom/parts/subsec__pom-crt.tex"
    moduleName := "Omega.Core.Fib"
    leanName := "Omega.fib_dvd_iff"
    phase := 195
    status := .formalized }
, { label := "thm:conclusion-foldbin-stable-collapse-ordered-k0-memory"
    sourcePath := "sections/body/conclusion/subsec__conclusion-window6-geometry-spectrum-arithmetic-information-obstructions.tex"
    moduleName := "Omega.Folding.Window6"
    leanName := "Omega.conclusion_window6_binfold_proper_coloring"
    phase := 195
    status := .formalized }
...
-- bridge:conclusion-window6-standard-collision → conclusion_window6_standard_collision (Window6.lean)
-- 状态: 已形式化, 审核通过 2026-03-26
