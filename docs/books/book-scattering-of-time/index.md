...
### 第一部：静默的流逝 (Part I: Silent Passage)

#### 第一章：希尔伯特空间的午后 (Chapter 1: Afternoon in Hilbert Space)

- [1.1 两个上帝的战争](part01-silent-passage/chapter01-afternoon-in-hilbert-space/01-01-war-of-two-gods.md)
- [1.2 宇宙终对象 ($\mathfrak U$) 与唯一的公理](part01-silent-passage/chapter01-afternoon-in-hilbert-space/01-02-universe-final-object-axiom.md)

#### 第二章：没有时间的时间 (Chapter 2: Time Before Time)

- [2.1 纯粹的生成](part01-silent-passage/chapter02-time-before-time/02-01-pure-becoming.md)
- [2.2 投影的艺术](part01-silent-passage/chapter02-time-before-time/02-02-art-of-projection.md)
- [2.3 罗塞塔石碑](part01-silent-passage/chapter02-time-before-time/02-03-rosetta-stone.md)

### 第二部：伟大的色散 (Part II: The Great Dispersion)

在第一部中，我们确立了宇宙的本体：一个在希尔伯特空间中以恒定速率 $c$ 演化的状态向量。但这只是故事的后台。在前台，在我们的感官世界里，这个统一的速率被打散了。它分裂成了我们眼中的"空间位移"和"时间流逝"。

这种分裂，就是物理学中一切运动和变化的起源。

#### 第三章：勾股定理统治宇宙 (Chapter 3: Pythagoras Rules the Universe)

- [3.1 伟大的权衡](part02-great-dispersion/chapter03-pythagoras-rules-universe/03-01-great-trade-off.md)
- [3.2 光子的破产](part02-great-dispersion/chapter03-pythagoras-rules-universe/03-02-bankruptcy-of-photon.md)

#### 第四章：时间的重量 (Chapter 4: The Weight of Time)

- [4.1 质量的几何起源](part02-great-dispersion/chapter04-weight-of-time/04-01-geometric-origin-of-mass.md)
- [4.2 惯性的本质](part02-great-dispersion/chapter04-weight-of-time/04-02-nature-of-inertia.md)
- [4.3 能量的锁死](part02-great-dispersion/chapter04-weight-of-time/04-03-locking-of-energy.md)

#### 第五章：光子的破产 (Chapter 5: The Bankruptcy of the Photon)

- [5.1 永生的代价](part02-great-dispersion/chapter05-bankruptcy-of-photon/05-01-cost-of-immortality.md)
- [5.2 计算上的赤贫者](part02-great-dispersion/chapter05-bankruptcy-of-photon/05-02-pauper-of-calculation.md)

### 第三部：时间的结 (Part III: The Knots of Time)

在这一部中，我们将不再把时间看作一条连续流动的河流，而是看作由无数微小节拍组成的数字序列。我们将发现，所谓的物质粒子——电子、夸克、光子——并不是漂浮在虚空中的独立实体，而是底层计算网格上某种特殊的**拓扑结构**。它们是时间流动的"死结"。

#### 第六章：底层的像素 (Chapter 6: The Underlying Pixels)

- [6.1 量子元胞 (QCA)](part03-knots-of-time/chapter06-underlying-pixels/06-01-quantum-cellular-automaton.md)
- [6.2 因果律即网速](part03-knots-of-time/chapter06-underlying-pixels/06-02-causality-as-connection-speed.md)
- [6.3 消失的马赛克](part03-knots-of-time/chapter06-underlying-pixels/06-03-vanishing-mosaic.md)

#### 第七章：作为缺陷的粒子 (Chapter 7: Particles as Defects)

- [7.1 拓扑死结](part03-knots-of-time/chapter07-particles-as-defects/07-01-topological-knots.md)
- [7.2 压缩残差](part03-knots-of-time/chapter07-particles-as-defects/07-02-compression-residuals.md)
- [7.3 对称性作为备份](part03-knots-of-time/chapter07-particles-as-defects/07-03-symmetry-as-backup.md)

#### 第八章：驻留与共振 (Chapter 8: Resonance as Residence)

- [8.1 $\kappa(\omega)$ 函数：连接微观与宏观的桥梁](part03-knots-of-time/chapter08-resonance-as-residence/08-01-kappa-function.md)
