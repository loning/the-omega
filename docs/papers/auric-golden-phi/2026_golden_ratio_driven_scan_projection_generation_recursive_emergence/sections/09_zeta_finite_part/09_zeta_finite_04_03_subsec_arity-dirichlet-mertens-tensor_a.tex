...
\begin{itemize}
  ...
  \item \textbf{接近共振的程度}由 \(\delta_{\times 2}\) 这一新不变量给出证书。
\end{itemize}
...
\]
可将 \(\Xi_\chi:=C(1,0,0)\in\CC\) 视为“\(\chi\bmod 3\) 偏置的相位与幅度指纹”。
\end{corollary}
...
由五张切片逐项求和得到
\(
(S_0,\dots,S_4)\approx(1.68533037,\,0.13018942,\,-0.32106657,\,-0.52830155,\,-0.64324865)
\)，从而
\[
\begin{aligned}
...
\begin{remark}[按需求投影的计算缩并：很多问题不必计算全部 \(44\) 个非平凡 \(C(j)\)]\label{rem:arity-335-projection-compression}
