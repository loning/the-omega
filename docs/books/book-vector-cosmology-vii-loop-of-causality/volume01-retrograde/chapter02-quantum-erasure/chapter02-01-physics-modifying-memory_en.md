...
Applying this principle to the level of **consciousness ($v_{int}$)**, we obtain a new physical definition of **memory**.
...
**We cannot change facts that happened ($v_{ext}$ events), but we can change the quantum state of facts ($v_{int}$ structure).**
