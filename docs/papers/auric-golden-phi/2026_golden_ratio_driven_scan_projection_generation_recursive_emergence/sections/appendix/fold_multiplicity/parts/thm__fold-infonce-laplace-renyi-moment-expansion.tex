...
\input{sections/appendix/fold_multiplicity/parts/thm__fold-infonce-loss-spectrum-identifiability}
\begin{corollary}[Bayes--InfoNCE 极小值序列对碰撞矩谱的三角反演]\label{cor:fold-infonce-triangular-inversion-collision-spectrum}
沿用定理 \ref{thm:fold-infonce-laplace-renyi-moment-expansion} 的记号，并令
\[
...
\qquad
(\Delta^t f)(0)=\sum_{j=0}^{t}(-1)^{t-j}\binom{t}{j}\log(1+j).
\]
