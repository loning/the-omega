...
\begin{remark}[公开检索注记]\label{rem:xi-comoving-prefix-public-search-note}
针对本组结果的结构关键词（包括“co-moving prefix bit budget”“Chebyshev co-moving center”等）所做公开检索，在当前可复核范围内未检出同式同题条目。该注记仅陈述检索可见性，不构成文献完备性证明，也不排除不同记号体系下的等价表述。
\end{remark}
