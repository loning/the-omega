...
Fix a window length $m$ and an addressing graph (e.g.\ a Hilbert-addressed grid).
...
At the minimal anchor $(m,n)=(6,3)$ one has $r=4$, and Section~\ref{sec:protocol_connections_holonomy} gives an explicit deterministic construction of an $S_4$ edge connection and its plaquette holonomy diagnostics.
\end{proof}
