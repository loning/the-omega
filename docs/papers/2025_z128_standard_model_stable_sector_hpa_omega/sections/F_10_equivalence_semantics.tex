...
%
\subsection{Resolution refinement as a projective semantics (uplift in $m$)}
...
\[
\mu_m(w):=\PP(W=w)=\frac{|P(w)|}{2^m},\qquad w\in X_m,
\]
...
\[
H(N\mid W)=\EE_{\mu_m}\!\left[\log |P(W)|\right].
\]
...
Moreover,
\[
D(\mu_m\Vert u_m)=\EE_{\mu_m}\!\left[\log\!\left(\frac{\mu_m(W)}{u_m(W)}\right)\right]
=\EE_{\mu_m}\!\left[\log\!\left(\frac{|P(W)|}{d_m}\right)\right]
