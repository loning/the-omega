...
Standard references include \cite{Koshy2001}.

\begin{remark}[Relation to the main text]
Lemma~\ref{lem:fib_two_sided_bounds_app} provides the two-sided bound used in Section~\ref{sec:fold_map}.
The main text records the same estimate as Lemma~\ref{lem:binet_bounds} together with Binet's formula.
\end{remark}
