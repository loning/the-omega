\section{Rigorous Proof of the DQCA Continuum Limit}

\begin{figure}[ht]
\centering
\includegraphics[width=0.8\textwidth]{assets/appendix-b-dqca-continuum.png}
\caption{DQCA Continuum}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\textwidth]{assets/appendix-b-discrete-lorentz-boost.png}
\caption{Discrete Lorentz Boost}
\end{figure}

\subsection{Momentum Space Representation of Discrete Evolution Operator}
...
\begin{itemize}
\item \textbf{Coin Operator $\hat{C}$}:
...
\item \textbf{Shift Operator $\hat{S}$}:
...
\subsection{Asymptotic Expansion and Continuum Limit}
...
\textbf{Step 1: Taylor Expansion of Evolution Operator}
...
\textbf{Step 2: Identifying the Hamiltonian}
...
This is precisely a representation of the \textbf{1+1 dimensional Dirac Hamiltonian} $H_D = c \alpha p + \beta m c^2$ (standard form can be obtained through basis transformation $\sigma_x \to -\sigma_x$).
...
\subsection{Error Analysis and Lorentz Violation Bounds}
...
We use the \textbf{Baker-Campbell-Hausdorff (BCH) Formula} to precisely calculate the effective Hamiltonian $H_{eff}$:
...
\textbf{Corrected Dispersion Relation}:
...
Therefore, the \textbf{exact dispersion relation} is:
...
\textbf{Conclusion B.1 (Lorentz Violation Term)}:
...
\subsection{3+1 Dimensional Generalization and Weyl Equation}
