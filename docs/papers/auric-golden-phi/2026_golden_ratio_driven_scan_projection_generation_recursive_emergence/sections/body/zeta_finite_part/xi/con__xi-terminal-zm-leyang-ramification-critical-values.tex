...
可由纯消元证书刻画为
\[
P_{\mathrm{LY}}(y)\ \doteq\ \mathrm{Res}_X\!\left(16X^3-9X^2+1,\ 4Xy-\bigl(4X^3-3X^2-2X+1\bigr)\right),
\]
其中 \(\doteq\) 表示相差一个非零有理常数因子。
...
4Xy=4X^3-3X^2-2X+1.
\]
对变量 \(X\) 作消元（结果式）即得到 \(P_{\mathrm{LY}}(y)=0\)（差一个非零常数因子），与结论 \ref{con:xi-terminal-zm-discriminant-leyang} 的判别式分解一致。
