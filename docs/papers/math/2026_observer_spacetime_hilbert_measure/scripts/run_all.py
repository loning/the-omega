...
def build_steps() -> List[Step]:
    return [
        Step(
            name="observer_hilbert_cost_scan",
            script="exp_observer_hilbert_cost_scan.py",
            args=[],
            expected_generated=[
                "tab_observer_hilbert_compare.tex",
                "observer_hilbert_summary.tex",
                "fig_observer_resolve_t_vs_dimension.tex",
            ],
        ),
        Step(
            name="hpa_ca_bidirectional_fixed_point",
            script="exp_hpa_ca_bidirectional_fixed_point.py",
            args=[],
            expected_generated=[
                "tab_hpa_ca_bidirectional_fixed_point.tex",
                "fig_hpa_ca_fixed_point_energy_curve.tex",
            ],
        ),
    ]
