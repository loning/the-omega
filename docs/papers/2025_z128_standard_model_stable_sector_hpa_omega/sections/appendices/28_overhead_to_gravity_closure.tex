\subsection{Overhead-to-gravity closure: from \texorpdfstring{$\kappa/\chi$}{kappa/chi} to lapse, potential, and weak-field tests}
...
\subsubsection{Overhead, lapse, and the \texorpdfstring{$\chi$}{chi} field}
...
\subsubsection{Rotation curves and a one-parameter fit for \texorpdfstring{$\gamma$}{gamma}}
...
Audit-facing practice is therefore to declare the derivative/smoothing rule and to report the stability of $\widehat\gamma$ under counterfactual step/regularization choices (Appendix~\ref{app:chi_reconstruction_protocol}).
