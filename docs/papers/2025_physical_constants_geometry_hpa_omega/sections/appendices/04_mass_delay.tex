...
\label{ax:mass_delay_chain}
Internal algebraic obstructions (nonassociative defects) act as phase-impedance centers that require extra scan cycles to resolve locally \cite{Baez2002Octonions,Okubo1995Nonassociative,Schafer1966Nonassociative}. The resulting increase in local scan density induces an effective metric stretching/time delay in the readout layer.
\end{axiom}
\noindent
The chain is
\begin{equation}
...
The relativistic dispersion $E^2=p^2+m^2$ provides a standard orthogonal decomposition between observable momentum and a rest-energy term. Empirically, gravitational time delay provides an operational reference for slowing effects \cite{Shapiro1964}.

\paragraph{External reference: Schwarzschild lapse and Shapiro delay.}
