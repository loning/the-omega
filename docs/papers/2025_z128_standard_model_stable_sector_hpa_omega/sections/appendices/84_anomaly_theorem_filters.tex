...
\AuditTag In the strong-closure carrier adopted by this manuscript (Appendix~\ref{app:eg_causal_perturbation_framework}), anomaly cancellation is the theorem-facing criterion for whether Slavnov--Taylor identities can be restored by local counterterms to the declared order (Appendix~\ref{app:eg_anomaly_counterterm_restoration}).
