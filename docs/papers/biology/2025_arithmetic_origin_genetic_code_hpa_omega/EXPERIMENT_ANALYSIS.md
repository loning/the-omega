...
- 2026-01-16 — **CLAIMED**: `H3-7b` icSHAPE probing deconfounding tightening（在 GSE132099 上加入更强成分控制：dinucleotide / codon-level proxies；检验 $\Delta R$–$\Delta U$ 是否在强控制下仍保留非零效应量，并输出可引用 fragment + 写入 paper）。Branch: `paper-bio`.
