...
\input{thm__xi-pick-poisson-vandermonde-resultant-identity}
...
\input{para__xi-pick-poisson-entropy-derivative-visible-dimension}
...
\input{parts/cor__xi-pick-poisson-near-collision-schur-collapse}

\input{para__xi-pick-poisson-schur-conditional-volume}
...
\input{subsubsec__xi-anchored-capacity-operator-ensemble}
