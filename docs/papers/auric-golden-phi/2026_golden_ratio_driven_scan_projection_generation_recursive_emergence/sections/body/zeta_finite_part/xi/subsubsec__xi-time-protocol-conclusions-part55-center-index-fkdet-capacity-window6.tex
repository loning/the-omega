...
若
\[
\ab_6:G_6^{\mathrm{bin}}\longrightarrow \bigl(G_6^{\mathrm{bin}}\bigr)^{\mathrm{ab}}
\]
为交换化映射，则 \(\ab_6|_{Z_{\partial}}\) 为单同态，其像恰为
\[
...
\]
因此三条中心 involution \(\tau_w\) 在交换化中的像彼此独立，\(\ab_6|_{Z_{\partial}}\) 为单同态，且其像正是 \(C_{\partial}\)。
