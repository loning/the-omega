...
\input{thm__hypercube-kraft-godel-sideinfo-lower-bound}
...
\input{sections/appendix/fold_multiplicity/thm__graph-cycle-lattice-theta-modular-inversion}
...
\input{sections/appendix/fold_multiplicity/thm__graph-energy-shell-lattice-counting}
...
\input{cor__hypercube-cycle-lattice-directsum-mdl}
...
\input{para__fold-hypercube-godel-stokes-walsh-hodge}

\input{thm__fold-coarsegraining-quadratic-stokes-area-rigidity}

\input{thm__fold-hypercube-godel-length-energy-upperbound}

\input{thm__fold-hypercube-stokes-plancherel-boundary-energy}
\input{thm__fold-hypercube-weighted-stokes-sobolev-energy-spectrum}
\input{cor__fold-boundary-torsor-h1-cohomology}
\input{cor__fold-boundary-hodge-stokes-orthogonal-decomposition}
\input{thm__fold-coarsegraining-naturality-rayleigh-stokes}
\input{conj__fold-boundary-stokes-langlands-modularity}
