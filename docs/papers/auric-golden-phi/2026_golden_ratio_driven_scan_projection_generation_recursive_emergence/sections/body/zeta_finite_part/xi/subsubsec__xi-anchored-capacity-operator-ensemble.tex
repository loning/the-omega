...
令 \(A=\{a_1,\dots,a_\kappa\}\subset\mathbb{D}\) 为锚定构型，并记端点通量 \(p_j:=P_{a_j}(-1)\)、\(p_{\Sigma}:=\sum_{j=1}^{\kappa}p_j\)。\footnote{据内部文稿 \cite{Internal2025ResolutionFoldingPhiPi}（2025）整理。归档时间戳：2026-02-14 11:15:36（Asia/Singapore）。}
定义极值亏损
\[
\boxed{\;
