...
* Wanting to drink a glass of water (cause) $\to$ having drunk the water (effect). This is a micro-pearl.
* Wanting to write a line of code (cause) $\to$ successful execution (effect). This is a medium pearl.
* Wanting to change fate (cause) $\to$ living in Auric state (effect). This is a giant pearl.
