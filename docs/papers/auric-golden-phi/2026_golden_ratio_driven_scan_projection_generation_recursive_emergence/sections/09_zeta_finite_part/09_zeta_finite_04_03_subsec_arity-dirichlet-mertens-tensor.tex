...
1-\rho_{3,3,p}/\lambda
=
\frac{\sigma_\xi^2}{2}\left(\frac{2\pi}{p}\right)^2+O(p^{-3})
\)
两边同乘 \((p/2\pi)^2\) 即得 \(D(p)=\sigma_\xi^2/2+O(p^{-1})\)，从而极限存在并等于 \(\kappa_\infty=\sigma_\xi^2/2\)。证毕。
\end{proof}
...
\frac{\sigma_\xi^2}{2}\left(\frac{2\pi}{p}\right)^2+O(p^{-3})
\ \le\
\frac{\varepsilon_\pi^{(2)}}{2}\left(\frac{2\pi}{p}\right)^2+O(p^{-3}).
$$
等价地，用 \(|1-\omega_p|^2=4\sin^2(\pi/p)\) 写成
$$
1-\frac{\rho_{3,3,p}}{\lambda}
\le
\frac{\varepsilon_\pi^{(2)}}{2}\,|1-\omega_p|^2\ +\ O(p^{-3}),
$$
