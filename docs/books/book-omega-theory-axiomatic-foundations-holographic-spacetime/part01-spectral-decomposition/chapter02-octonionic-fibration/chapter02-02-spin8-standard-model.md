...
![Spin8标准模型](../../assets/chapter02-02-spin8-standard-model.png)
...
![Spin8向量旋量镜像](../../assets/chapter02-02-spin8-vector-spinor-mirror.png)
...
根据数学定理，八元数的自同构群 $G_2$ 中，保持某个虚单位 $i$ 不变（即确定了复平面结构，对应于电磁力的分离）的子群，恰好是 **$SU(3)$**。
