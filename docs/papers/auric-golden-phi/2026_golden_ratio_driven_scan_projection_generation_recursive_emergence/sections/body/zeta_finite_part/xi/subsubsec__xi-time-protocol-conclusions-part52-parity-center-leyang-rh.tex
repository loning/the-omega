...
\begin{corollary}[分支立方域与振幅平方立方域的共同二次解消子域]\label{cor:xi-leyang-u-b-square-common-quadratic-resolvent}
...
162b^3+1593b^2+1998b+1184=0
\]
虽然书写不同，却具有同一个唯一二次解消子域
\[
\boxed{\;
\QQ(\sqrt{-111}).\;}
\]
等价地，这两个 \(S_3\)-三次模型的 Galois 闭包共享同一二次子域。
\end{corollary}
\begin{proof}
由定理 \ref{thm:killo-leyang-kappa-square-cubic-field}，
\[
...
\begin{theorem}[核版 RH 临界点先于最近复分歧]\label{thm:xi-rh-critical-before-nearest-complex-branch}
