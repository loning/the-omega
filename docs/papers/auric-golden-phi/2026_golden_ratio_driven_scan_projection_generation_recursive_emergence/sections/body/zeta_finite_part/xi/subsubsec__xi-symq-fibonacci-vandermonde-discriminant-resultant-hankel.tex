...
\begin{theorem}[秩一耦合的 Sylvester 结果式：谱差积的 Fibonacci 分解]\label{thm:xi-symq-kj-resultant-fibonacci}
令
\[
...
\begin{proposition}[Hankel--Sylvester 桥接：谱差结果式的幂矩行列式模型]\label{prop:xi-symq-hankel-sylvester-bridge}
令
\[
