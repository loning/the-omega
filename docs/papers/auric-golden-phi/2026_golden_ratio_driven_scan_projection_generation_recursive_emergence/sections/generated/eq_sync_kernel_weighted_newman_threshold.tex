...
\[
P(\mu,u)=\mu^6-(1+u)\mu^5-5u\mu^4+3u(1+u)\mu^3-u(u^2-3u+1)\mu^2+u(u^3-3u^2-3u+1)\mu+u^2(u^2+u+1).
\]
...
\[
\begin{aligned}
Q(u)=u^{37} - 18 u^{36} + 123 u^{35} - 221 u^{34} - 1411 u^{33} + 4161 u^{32}\\
&\ + 22245 u^{31} - 52892 u^{30} - 158348 u^{29} - 42120 u^{28} + 606774 u^{27} + 3909659 u^{26}\\
&\ + 10387009 u^{25} - 37765093 u^{24} - 151950784 u^{23} + 25871406 u^{22} + 719435033 u^{21} + 601196630 u^{20}\\
&\ - 492437336 u^{19} + 626156178 u^{18} + 2164952510 u^{17} + 152029078 u^{16} - 730207162 u^{15} + 852147877 u^{14}\\
&\ + 184868548 u^{13} - 801264087 u^{12} - 85113751 u^{11} - 26931053 u^{10} - 93461933 u^{9} - 31696133 u^{8}\\
&\ - 1058443 u^{7} + 1222403 u^{6} + 137062 u^{5} - 10803 u^{4} - 2098 u^{3} - 61 u^{2}\\
&\ + 9 u + 1.
\end{aligned}
\]
