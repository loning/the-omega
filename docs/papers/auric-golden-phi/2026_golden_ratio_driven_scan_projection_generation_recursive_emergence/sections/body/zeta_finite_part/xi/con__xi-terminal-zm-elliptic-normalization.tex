...
据 \cite{LMFDBEllipticCurve37a1} 的记录（访问于 \(2026\text{-}02\text{-}18\)（Asia/Singapore，20:03:49）），在 Cremona/LMFDB 的标准标识下，\(E\) 为导子 \(37\) 的同源类 \(37\mathrm a\) 之强 Weil 曲线（记号 \(37\mathrm a1\)）；
...
特别地，结论 \ref{con:xi-terminal-zm-discriminant-leyang} 的唯一负实分歧值 \(y_{\mathrm{LY}}\) 对应于三次方程 \(16\lambda^3-9\lambda^2+1=0\) 的唯一实根 \(\lambda_{\mathrm{LY}}\)，并满足
%
