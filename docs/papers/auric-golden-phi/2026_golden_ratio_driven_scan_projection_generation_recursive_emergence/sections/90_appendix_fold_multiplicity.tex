...
\begin{remark}[三轴窗上的零点增量：\texorpdfstring{$m=58$}{m=58} 给出 \texorpdfstring{$|\mathcal{Z}_{58}|\ge F_{30}$}{|Z58|≥F30}]\label{rem:fold-zero-lb-m58}
...
\[
\boxed{\ |\mathcal{Z}_{58}|\ge F_{30}=832040\ }.
\]
