...
本小节整理自 2026-02-17 的内部推导文档。除注 \ref{rem:sync-hatdelta-explicit} 所定义之完成化行列式
...
\]
其在 \(\QQ\) 上的伽罗瓦群为 \(S_6\)。
一般情形的伽罗瓦群是 \(S_6\) 的一个传递子群，并且特化不会增大伽罗瓦群：对除有限多个退化参数外的特化，特化伽罗瓦群可视为一般伽罗瓦群的一个子群；因此一旦存在某个特化得到 \(S_6\)，一般伽罗瓦群只能为 \(S_6\)。
