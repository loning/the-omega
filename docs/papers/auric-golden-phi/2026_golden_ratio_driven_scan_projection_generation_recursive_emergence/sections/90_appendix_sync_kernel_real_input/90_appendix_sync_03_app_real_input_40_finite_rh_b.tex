...
\paragraph{toy-RH 的“真实 RH 研究形态”五件套：可审计接口清单}\label{par:finite-rh-rhstyle-toolkit}
为了避免把同一内容以多种叙事重复陈述，这里把本文已经得到的“RH 形状”接口按研究路线所需的层级重新打包为五个可审计部件，均对应本文中已给出的可引用命题/定理：
\begin{enumerate}
...
\begin{itemize}
  ...
  \item \textbf{临界线上零点比例：}已有结果表明超过 \(5/12\) 的零点位于临界线（\cite{PrattRoblesZaharescuZeindler2018FiveTwelfths}）。该类“占比提升”可被视为把偏离临界线的零点集合压稀的一条可累积路线。
