...
\begin{conclusion}[同调极小化刻画：\(A_{\mathrm{flip}}\) 是 \([\beta]\) 的 \texorpdfstring{$\ZZ_2$}{Z/2}-奇闭链能量极小值]\label{con:xi-split-tunneling-aflip-homological-minimization}
...
A_{\mathrm{flip}}
=
\min\bigl\{\kappa(c):\ c\ \text{为}\ \ZZ_2\text{-}1\text{-循环且}\ \langle[\beta],c\rangle=1\bigr\}.
\]
