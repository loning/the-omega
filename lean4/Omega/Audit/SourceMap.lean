...
, { label := "prop:pom-s3-recurrence"
    sourcePath := "sections/body/pom/parts/subsec__pom-s5.tex"
    moduleName := "Omega.Folding.MomentTriple"
    leanName := "Omega.tripleCollisionClass_111_eq_000"
    phase := 112
    status := .formalized }
, { label := "prop:pom-s3-recurrence"
    sourcePath := "sections/body/pom/parts/subsec__pom-s5.tex"
    moduleName := "Omega.Folding.MomentTriple"
    leanName := "Omega.tripleCollisionClass_001_eq_010"
    phase := 112
    status := .formalized }
, { label := "prop:pom-s3-recurrence"
    sourcePath := "sections/body/pom/parts/subsec__pom-s5.tex"
    moduleName := "Omega.Folding.MomentTriple"
    leanName := "Omega.tripleCollisionClass_010_eq_100"
    phase := 112
    status := .formalized }
, { label := "prop:pom-s3-recurrence"
    sourcePath := "sections/body/pom/parts/subsec__pom-s5.tex"
    moduleName := "Omega.Folding.MomentTriple"
    leanName := "Omega.tripleCollisionClass_011_eq_101"
    phase := 112
    status := .formalized }
, { label := "prop:pom-s3-recurrence"
    sourcePath := "sections/body/pom/parts/subsec__pom-s5.tex"
    moduleName := "Omega.Folding.MomentTriple"
    leanName := "Omega.tripleCollisionClass_101_eq_110"
    phase := 112
    status := .formalized }
, { label := "prop:pom-s3-recurrence"
    sourcePath := "sections/body/pom/parts/subsec__pom-s5.tex"
