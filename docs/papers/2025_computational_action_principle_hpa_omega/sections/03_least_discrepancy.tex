...
\subsection{Phase potential and phase pressure: mismatch sources generate \texorpdfstring{$1/r$}{1/r} fields}
...
\end{equation}
This Gauss-law relation parallels the curvature-flux characterization of topological sectors in Section~\ref{sec:matter_defects}.
\end{remark}

For an isolated localized source (compactly supported $\sigma$), the exterior solution is harmonic; in the far field the monopole term dominates, and for an approximately spherically symmetric core one may write
\begin{equation}
  \Phi(r) = -\frac{M}{r},
  \qquad
