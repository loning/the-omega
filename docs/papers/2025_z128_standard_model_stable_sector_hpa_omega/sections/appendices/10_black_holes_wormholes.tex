...
\AuditTag For the manuscript-wide unified meaning of ``wormhole-like channel'' (paid pointer-jump shortcut + three hard gates) and the associated audit-only operator/pole-barrier vocabulary,
...
\midrule
\input{sections/generated/wormhole_pointer_jump_rows.tex}%
\end{tabular}
...
\input{sections/generated/wormhole_pointer_jump_summary.tex}
