\input{subsubsec__xi-poisson-cauchy-cayley-multipole-expansion}
...
\begin{remark}[同形检索的范围说明]\label{rem:xi-poisson-cauchy-cayley-jensen-public-index-scope}
围绕上述常数与系数结构（\(\|R\|_{L^2}=\frac{\sqrt3}{4\sqrt\pi}\)、\(\|R\|_\infty=\frac1\pi\)、以及
\(\frac{3\mu_3^2}{32}-\frac{\mu_2\mu_4}{8}+\frac{\mu_2^3}{64}\)）所做公开索引检索，
在既定关键词与参数化口径下未发现同形逐项表述；
该检索仅用于排除显然重复条目，不构成形式意义上的完备新颖性证明。
\end{remark}
