...
该扫描—投影接口亦可在紧群与算子代数语言中等价表述：例如令相空间为紧群（或其齐性空间），以平移/旋转给出保测变换 $T$，以窗集指示函数给出读出 $s_t$；在 Hilbert 空间表示中则以幺正算子 $U$ 与投影 $P$ 表述读出算子族 $P_t=U^{-t}PU^t$（见附录 A）。

\subsection{概念的空值投影范式}
