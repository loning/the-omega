...
\paragraph{Adams 扭曲端点核：\texorpdfstring{$(-1)$}{(-1)} 的 \texorpdfstring{$d$}{d} 次根原子质量读出}
\begin{theorem}[Adams 扭曲下的端点热核族]\label{thm:xi-endpoint-heat-probe-adams-twist-roots}
...
\end{proof}
\input{parts/thm__xi-endpoint-heat-probe-cyclotomic-targets}
