\paragraph{Smith 谱分类、模核 \texorpdfstring{$\zeta$}{zeta} 主因子、整数椭圆原子分解与有限时域账本预算}
前述有限秩账本障碍之后，Smith 信息亏损谱的局部分类、模核计数的 Dirichlet 全局化、整数轴对齐椭圆的原子结构，以及有限时域自然扩张的最小二进制外置预算还可继续压缩为下列结构性结论。
