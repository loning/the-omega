...
\input{thm__xi-crt-multistage-axis-allocation-additive-control}

\input{subsubsec__xi-hankel-syndrome-random-prime-single-round-refutation}
...
\input{subsubsec__xi-syndrome-shift-invariant-saturated-lattices}
\begin{proof}
行最简形给出子空间的规范代表。
