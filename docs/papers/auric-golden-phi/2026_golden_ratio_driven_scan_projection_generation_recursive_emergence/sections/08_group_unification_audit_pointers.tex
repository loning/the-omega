...
\begin{itemize}
  ...
  \item \textbf{审计 JSON：}\texttt{\detokenize{artifacts/export/window6_c6_orbit_patisalam_seed.json}}（含 \(C_6\) 轨道、\(\Delta_6=\{0,21,34,55\}\)、\(w_6=1\Rightarrow\{0,34\}\)、三条边界词的显式 preimage 对，以及 \(m=6,7,8\) 的 boundary-lift 三层/二层稳定性扫描结果）。
\end{itemize}
