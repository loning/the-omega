...
The run_id is a sha256 fingerprint of:
  - experiment name
  - parameters (JSON)
  - script content hash (so code changes invalidate cache)
  - optional extra fingerprint (e.g., external dependency file hashes)
"""
...
def make_run_id(experiment: str, params: Dict[str, Any], script_path: Path, extra_fingerprint: Optional[Dict[str, Any]] = None) -> str:
