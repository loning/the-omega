...
\begin{enumerate}
  ...
  \]
  特别地，素数 \(37\) 在 \(K\) 中必分歧；结合结论 \ref{con:xi-terminal-zm-elliptic-normalization} 与注记 \ref{rem:xi-terminal-elliptic-37a1-modular-anchor}，其亦为谱椭圆曲线 \(E\) 的导子与唯一奇素坏约化点，从而在素数层面把 Lee--Yang 分歧算术与 level \(37\) 的模性锚点对齐。
