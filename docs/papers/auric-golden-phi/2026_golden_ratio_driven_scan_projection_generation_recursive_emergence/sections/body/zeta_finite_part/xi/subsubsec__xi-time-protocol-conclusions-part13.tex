% (User input window)
% 2026-02-14 10:58:52（Asia/Singapore，UTC+08）
...
\end{conclusion}
\begin{proof}[证明]
见注 \ref{rem:pom-gibbs-markov-fit} 与注 \ref{rem:pom-gibbs-parry-entropy-gap}（其中数值证书由 \texttt{scripts/exp\_fold\_output\_gibbs\_markov\_fit.py} 生成并以 \(\input\) 方式纳入正文）。证毕。
\end{proof}
