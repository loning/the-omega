...
For the short rigidity spine that unifies the paper's entropy-gap, determinant/trace, and invariance vocabulary (so that later dictionary uses do not rely on dispersed reminders), see Section~\ref{sec:rigidity_bridge_spine}.
