...
| Q4 | Q4-R17 | PARTIAL PASS (special cases + monotone-sum all-n theorem + heat intertwining + derivative recursion + transform-factor decomposition + edge-score first-moment identity closed; added single-bottleneck sufficient reduction and explicit n=8 counterexample showing it is too strong; added concavity-defect decomposition and direct adversarial tests of concavity numerator with no positive counterexample found up to tested n=14; general boxplus n>=4 open) |
| Q5 | Q5-R5 | PASS |
