...
\input{prop__circle-dimension-phase-gate-stokes-homology-splitting}
\input{conj__circle-dimension-phase-gate-walsh-stokes-stokes-character-unification}
...
\input{part__circle-dimension-phase-gate-stokes-relative-explicit-model}
...
\input{part__circle-dimension-phase-gate-fiber-integration-stokes-defect}
...
\input{subsubsec__circle-dimension-phase-gate-semiring-rigidity}
