...
\[
\sup_{\xi\in\supp(\mu)\setminus\{-1\}}r(\xi)\le r_\star,
\]
则对所有 \(N\ge 0\) 有指数型误差界
...
\boxed{\;
r_\ast:=\sup_{\xi\in\supp(\mu)\setminus\{-1\}}r(\xi)\in[0,1].\;}
\end{equation}
...
\)。
对下界，任取 \(\varepsilon>0\)。由 \(r_\ast\) 为支撑上的上确界，存在 \(\xi_0\in\supp(\mu)\setminus\{-1\}\) 使 \(r(\xi_0)>r_\ast-\varepsilon\)。
