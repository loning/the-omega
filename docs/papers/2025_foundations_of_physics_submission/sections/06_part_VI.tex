...
Locally, this unitary can be implemented as a bounded quantum circuit of depth $d=3$. The "Golden Gate" $G(\phi)$ provides the mixing between the $z$-basis (information) and $x$-basis (coherence). Explicitly, in the computational basis $\{|0\rangle, |1\rangle\}$:
\begin{equation}
