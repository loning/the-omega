...
The Fermilab Holometer experiment rules out "Random Walk" holographic noise ($\delta x \sim \sqrt{L l_P}$). However, the Omega Network is algorithmically deterministic. The noise is non-Markovian (colored), with high-frequency spectral cut-offs determined by the Golden Unitary spectrum, evading the white-noise Constraints of interferometers.
