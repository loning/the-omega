...
\begin{remark}[公开检索可见性说明]\label{rem:xi-replay-godel-prime-public-search-note}
在公开检索口径下，以“Gödel numbering + reversible projection”“adjunction + Gödel numbering”“prime interleaving + Gödel encoding”等关键词组合检索，未见与本段定理链在同一语义框架与同一表述层级下的同名结果。
该注记仅陈述当前可见检索现象，不构成穷尽性文献排他证明。
\end{remark}
