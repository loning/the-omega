...
\]
若“近共边界的小角微扰”机制成立，则 \(g(p)\) 应仅缓慢漂移并趋向常数量级（等价地 \(\kappa_p\) 逼近极限 \(\kappa_\infty=\sigma_\xi^2/2\)）；若“\(p=5\) 的特异共振”机制成立，则 \(g(5)\) 将显著偏离其它素数。对 \(p\in\{5,7,11,13\}\) 的可复现扫描见表 \ref{tab:real_input_40_arity_335_n2_selection_law_primes} 与注记 \ref{rem:arity-335-selection-law-gp}。
\end{remark}
