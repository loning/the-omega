...
由该曲线的标准 Mordell--Weil 数据（Cremona 标记 \(37\mathrm{a}1\)，见 \url{https://www.lmfdb.org/EllipticCurve/Q/37/a/1}），
...
\]
其中 \(P=(2,\tfrac52)\) 为结论 \ref{con:xi-terminal-zm-elliptic-rational-points-denominator-law} 的物理基点。
并且
\(
y(Q_0)=0,\ y(Q_0')=1
\)，
...
在 LMFDB 的标准 N\'eron--Tate 规范化下（同一曲线 \(37\mathrm{a}1\) 的高度/调节子页面：\url{https://www.lmfdb.org/EllipticCurve/Q/37a1/}），生成元 \(R_0=(0,0)\) 的标准高度为
\[
