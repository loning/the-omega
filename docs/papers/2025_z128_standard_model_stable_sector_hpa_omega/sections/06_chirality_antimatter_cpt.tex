...
In continuous settings, signed turning and orientation couple naturally to geometric phase (Berry phase) and to spinorial sign structures.
The finite $n=3$ computation therefore provides a minimal auditable toy model for the statement
\[
