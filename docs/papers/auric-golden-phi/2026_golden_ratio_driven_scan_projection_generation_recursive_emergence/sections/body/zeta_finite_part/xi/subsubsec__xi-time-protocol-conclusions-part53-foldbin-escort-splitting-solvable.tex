...
在定理 \ref{thm:xi-foldbin-collision-probability-normalized-groupoid-dimension} 的碰撞公式与定理 \ref{thm:xi-gauge-volume-boltzmann-stirling-exponential} 的指数律之间，还存在一条由 escort 相对熵控制的精确桥接；同时，定义 \ref{def:fold-bin-gauge-sign} 的纤维奇偶荷可把 Abel 化、中心与可解性统一为纯纤维判别。
