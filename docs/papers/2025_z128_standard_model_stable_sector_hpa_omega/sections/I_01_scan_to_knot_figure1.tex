...
Under the minimal two-bin-per-DoF convention, this creates a geometric bottleneck at $m=6$ in the derived $d=3$ dictionary: the readout must fold its local patterning to supply a coarse position--orientation frame.
