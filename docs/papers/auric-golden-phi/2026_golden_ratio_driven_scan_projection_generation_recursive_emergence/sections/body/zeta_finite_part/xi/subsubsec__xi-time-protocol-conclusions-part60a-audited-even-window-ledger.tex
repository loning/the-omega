...
本段把附录中已建立的 bin-fold 退化谱、规范群与 Stirling 展开结果，回收为五条可直接调用的终端结论：它们分别刻画审计偶数窗上的中心坍缩与 Abel 满秩分离、最大纤维组合上界的精确饱和判据、\(\kappa_m\)--KL--碰撞概率之间的恒等链、规范群体积的三因子乘法分解，以及最小退化扇区单独强制的显式碰撞下界。
