...
To keep the present manuscript self-contained, we also record (i) a minimal overhead-to-gravity closure and (ii) an executable $\chi(x)$ reconstruction protocol in Appendices~\ref{app:overhead_to_gravity_closure} and \ref{app:chi_reconstruction_protocol}.
...
Within this paper, the protocol-level overhead-to-gravity bridge that interprets these templates is recorded explicitly in Appendix~\ref{app:overhead_to_gravity_closure}, and an executable data protocol to reconstruct $\chi(x)$ is recorded in Appendix~\ref{app:chi_reconstruction_protocol}.
