...
\chapter{遍历性破缺与创生机制}
\input{part01-spectral-decomposition/chapter01-ergodicity-breaking/chapter01-01-weyl-equidistribution.tex}
\input{part01-spectral-decomposition/chapter01-ergodicity-breaking/chapter01-02-poincare-recurrence.tex}
...
\input{part01-spectral-decomposition/chapter02-octonionic-fibration/chapter02-02-spin8-standard-model.tex}
...
\chapter{欧米伽单元与因果结构}
\input{part02-discrete-manifolds/chapter03-omega-cell/chapter03-01-penrose-fibonacci-tiling.tex}
\input{part02-discrete-manifolds/chapter03-omega-cell/chapter03-02-lorentz-covariance.tex}
...
\input{part02-discrete-manifolds/chapter04-computational-ontology/chapter04-03-zitterbewegung-mass.tex}
...
\input{part03-holographic-dynamics/chapter05-omega-action/chapter05-03-entropic-gravity.tex}
\input{part03-holographic-dynamics/chapter05-omega-action/chapter05-04-total-budget-conservation.tex}
...
\input{part04-phenomenology/chapter07-geometric-resonance/chapter07-03-cosmic-intrinsic-time.tex}
\input{part04-phenomenology/chapter07-geometric-resonance/chapter07-04-experimental-verification-schemes.tex}
...
\chapter{意识的物理形式化}
\input{part05-interactive-self-reference/chapter08-consciousness-formalization/chapter08-01-godel-incompleteness.tex}
\input{part05-interactive-self-reference/chapter08-consciousness-formalization/chapter08-02-interactive-turing-machine.tex}
...
\input{part05-interactive-self-reference/chapter09-omega-point/chapter09-06-generalized-euler-identity.tex}
\input{part05-interactive-self-reference/chapter09-omega-point/chapter09-07-ontological-geometry.tex}
\input{part05-interactive-self-reference/chapter09-omega-point/chapter09-08-recursive-universes.tex}
\input{part05-interactive-self-reference/chapter09-omega-point/chapter09-09-descent.tex}
\input{part05-interactive-self-reference/chapter09-omega-point/chapter09-10-conclusion.tex}

\appendix

% Appendix A: Octonionic Algebra and Spin(8) Triality
\chapter{八元数代数与 Spin(8) 三里性}
\input{appendices/appendix-a-octonions-spin8.tex}
...
\chapter{参考文献与索引}
\input{appendices/appendix-d-bibliography-index.tex}

% Appendix F: The Cosmic Trinity
\chapter{\texorpdfstring{宇宙的三位一体——$\pi, e, \phi$ 的终极关系}{宇宙的三位一体——pi, e, phi 的终极关系}}
\input{appendices/appendix-f-cosmic-trinity.tex}
