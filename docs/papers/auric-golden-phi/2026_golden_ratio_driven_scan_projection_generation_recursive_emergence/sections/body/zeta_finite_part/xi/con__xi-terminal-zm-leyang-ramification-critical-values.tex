...
\begin{enumerate}
  ...
  等价地，可用纤维分割型写为
  \[
  (4)\ \big|\ (\underbrace{2,1,1}_{y=0})\ (\underbrace{2,1,1}_{y=1})\ (\underbrace{2,1,1}_{y=y_{1}})\ (\underbrace{2,1,1}_{y=y_{2}})\ (\underbrace{2,1,1}_{y=y_{3}}),
  \qquad P_{\mathrm{LY}}(y_{j})=0.
  \]
