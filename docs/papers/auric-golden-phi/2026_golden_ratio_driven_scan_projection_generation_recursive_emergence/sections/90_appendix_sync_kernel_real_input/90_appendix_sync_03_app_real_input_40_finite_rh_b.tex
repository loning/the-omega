...
本稿的“有限核 \(\zeta=\det(I-zT)^{-1}\)”原型与经典 RH 研究的三条成熟谱路线在结构上可直接对齐；其差异仅在于“算子所处的范畴（有限矩阵 vs.\ 无限维核算子）”与“扭曲索引的算术来源（角色/覆盖 vs.\ Hecke/素数）”：
\begin{itemize}
  ...
  经典 RH 的一条谱解释路线是把显式公式写成 trace formula，并把临界零点视作某种“谱/共振”（见 \cite{Connes1999TraceFormulaNCG}）。从本文角度，这对应于把“trace/primitive 的交换图”（本稿已闭合）提升为一个带算术对称的算子范畴：扭曲通道的组织不再仅来自有限群角色，而由 Hecke/素数索引的算子族提供。
\end{itemize}
