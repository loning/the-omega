...
\begin{proposition}[循环稳定语言计数]\label{prop:Cm_Lm}
\MathTag
...
当 $m=1$ 时，$C_1=\{0\}$，故 $\abs{C_1}=1=L_1$；当 $m=2$ 时，循环约束等价于线性无相邻约束，$C_2=X_2$，故 $\abs{C_2}=3=L_2$。以下设 $m\ge 3$。按 $w_1$ 分类：
\begin{itemize}
