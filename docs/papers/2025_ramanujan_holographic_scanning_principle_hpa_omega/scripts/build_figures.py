...
def _set_reproducible_seed(seed: int) -> None:
    ...
    try:
        ...
        # numpy is optional for seeding; figures require it but keep this robust.
        pass
...
def main() -> int:
    ...
    # Import modules from scripts/figures without shadowing paper_dir/figures output dir.
