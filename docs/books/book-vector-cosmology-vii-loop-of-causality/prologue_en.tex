...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{assets/prologue/00-01-01-end-linear-time.png}
\caption{The End of Linear Time}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{assets/prologue/00-02-01-wheeler-eye-autophagy.png}
\caption{Wheeler's Eye: Autophagy}
\end{figure}
