...
This candidate-family input may be supplied via either of the following interface routes:
...
or \textbf{(G3b) optional microscopic route} (Assumption~\ref{ass:m2star_internal_fiber_g2} in Appendix~\ref{app:internal_fiber_g2_optional}).
No equivalence between these routes is assumed; they are alternative ways to underwrite the same interface-family stance.
