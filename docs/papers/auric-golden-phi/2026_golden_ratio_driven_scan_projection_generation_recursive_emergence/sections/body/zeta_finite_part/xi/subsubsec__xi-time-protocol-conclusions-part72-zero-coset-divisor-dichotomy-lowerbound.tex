\paragraph{奇倍嵌套链、约数格指标容斥与线性零点增量}
在零余类族的 \(\gcd\)-刚性交结构与谱零点集合的加权 clique--Euler 公式已经建立之后，还可继续沿约数格方向抽取出下列三条直接后果。它们分别刻画整除链上的奇倍嵌套--偶倍排斥二分律、以相容指标书写的约数格精确容斥公式，以及 pairwise-incompatible 约数族所导致的线性零点增量下界。
