...
\begin{remark}[（原稿编号为 Conjecture B.211）闭轨 arity-charge 非负性]\label{rem:real-input-40-arity-charge-conjecture-b211}
定理 \ref{thm:real-input-40-arity-charge-coboundary} 给出了 arity-charge 在闭轨上的非负性，
从而证实 Conjecture B.211；更强的是它提供了逐边的 $0/1$ 共边界证书。
\end{remark}
