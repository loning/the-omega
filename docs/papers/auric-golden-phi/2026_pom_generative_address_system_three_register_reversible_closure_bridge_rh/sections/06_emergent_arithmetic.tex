...
本节在 POMmin 下于稳定地址空间内生构造自然数对象以及加法、乘法运算，并证明所得结构与经典半环同构。为避免引入额外拓扑结构，本节将稳定地址空间取为 Zeckendorf 合法数字的有限支撑部分，即定义 \ref{def:Z-fiber} 中的 $Z$；记号上亦可将其视为 $X_\infty$ 的有限支撑子对象。
