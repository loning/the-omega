...
\)
及“无迹协方差主导二阶塌缩”结构（结论
\ref{con:xi-poisson-cauchy-second-order-constants-with-mu3-remainder}、
\ref{cor:xi-poisson-cauchy-fisher-krein-tail-half-var2}、
\ref{thm:xi-poisson-cauchy-two-parameter-tracefree-covariance-structure}、
\ref{cor:xi-poisson-cauchy-covariance-balance-supersecond-collapse}、
\ref{con:xi-golden-resolution-certificate-tracefree-covariance-bottleneck}），
可与注 \ref{rem:xi-poisson-refined-sixth-order-public-index-check} 联读。
在既定中英文关键词与参数化口径下，公开索引未发现同形直接对应条目；但该检索不构成形式意义上的文献完备性证明。
\end{remark}
\endinput