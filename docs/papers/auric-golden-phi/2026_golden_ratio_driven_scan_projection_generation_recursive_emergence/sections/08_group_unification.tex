...
\[
\mathsf{Col}_{58}\approx 8.7965\times 10^{-13},\qquad
\frac{1}{F_{60}}\approx 6.4599\times 10^{-13},\qquad
g_{\mathrm{col}}^2(58)\approx 2.3366\times 10^{-13}.
\]
等价地，用无量纲比值表示为 \(F_{60}\mathsf{Col}_{58}\approx 1.3617\)，从而 \(F_{60}g_{\mathrm{col}}^2(58)\approx 0.3617\)。
\end{remark}
...
\input{sections/08_group_unification_fibonacci_lie_resonance_ladder.tex}

\input{sections/08_group_unification_spectral_alignment.tex}

\input{sections/08_group_unification_audit_pointers.tex}
