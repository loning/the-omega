...
\end{lemma}
\begin{proof}
Reversing the orientation multiplies the integration functional on top-degree forms by $-1$ by definition of the induced volume element. Applying this to $\alpha$ gives the sign flip. Taking $\alpha=\varphi\wedge p_1(T\mathcal{M}_7)$ yields the stated parity-odd property of $\chi_\Omega$.
\end{proof}
