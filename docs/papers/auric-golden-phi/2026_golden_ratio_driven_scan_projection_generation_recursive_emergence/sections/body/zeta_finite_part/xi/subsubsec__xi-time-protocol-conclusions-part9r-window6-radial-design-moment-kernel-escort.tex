...
\noindent
由此，window-\(6\) 的径向根几何、附录 \(E\) 的整数 moment-kernel 谱族与有限窗 escort 冻结在同一条终端链上闭合：径向方向集在三阶球面矩处精确封闭而在四阶首次分叉，整数退化谱根满足 Fekete 型次乘规律并强制出单一谱根尺度，有限窗 escort 则坍缩为一个精确可解的三能级模型。这组结构为把离散谱根尺度与冻结支撑函数置于同一 Fenchel--Fekete 变分接口提供了自然起点。
