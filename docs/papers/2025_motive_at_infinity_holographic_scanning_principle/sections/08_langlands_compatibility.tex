...
In this diagram, the arrow $\HSP$ is \emph{closed} and auditable within this paper. The remaining arrows are programmatic interfaces, to be developed in controlled cases where they can be made explicit.
