...
\begin{enumerate}
  ...
  \item \textbf{（Taylor 收敛半径）} 在主值对数下，数值上
  \[
  u_0\approx -0.0933476230,\qquad
  u_{\pm}\approx -3.0783261885\pm 3.4567613473\,i,
  \]
  从而最近分歧点可取
  \[
  \log u_{\pm}\approx 1.5322860265\pm 2.2983508889\,i,
  \]
  并且 \(P_2(\theta)\) 在 \(\theta=0\) 的 Taylor 级数收敛半径为
  \[
  \boxed{\ R_\theta=\min_{j}\ \min_{k\in\ZZ}\bigl|\log u_j+2\pi i k\bigr|\approx 2.7623028935\ }.
  \]
\end{enumerate}
\end{corollary}
\begin{proof}
