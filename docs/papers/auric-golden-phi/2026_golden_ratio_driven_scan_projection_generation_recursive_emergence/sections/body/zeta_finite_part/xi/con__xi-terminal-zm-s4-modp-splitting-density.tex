...
取 \(y_{0}\in\QQ\setminus\bigl(\{0,1\}\cup\{P_{\mathrm{LY}}(y)=0\}\bigr)\)，并假设专化四次 \(\Pi(\lambda,y_{0})\in\QQ[\lambda]\) 在 \(\QQ\) 上不可约。
则成立判别准则
\[
\boxed{\;
