...
\begin{remark}[同形公开索引核验说明]\label{rem:xi-ed-xa-xv-sameform-public-index-note}
围绕定理 \ref{thm:xi-resolvent-dihedral-elliptic-birational} 至
\ref{thm:xi-jac-xa-q-indecomposable-via-p13}
中出现的显式系数与结构同形，当前文本仅保留“可检索范围内未见同式”的索引性说明。
该信息不替代形式意义上的排他性文献证明。
\end{remark}
